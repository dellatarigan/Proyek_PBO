 ...
 * @author ASUS
 */
public class PendisiplinForm extends javax.swing.JFrame {

    /**
     * Creates new form PendisiplinForm
     */
    public PendisiplinForm() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PendisiplinForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PendisiplinForm().setVisible(true);
            }
        });
    }
